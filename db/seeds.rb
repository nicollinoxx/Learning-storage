...
PaymentType.create(description: "Check" )
PaymentType.create(description: "Credit card" )
PaymentType.create(description: "Purchase order" )

User.create! name: 'dave', password: Rails.application.credentials.my_password, password_confirmation: Rails.application.credentials.my_password
